...
import com.seetatech.demo.config.AppConfig;
import com.seetatech.demo.utils.FileUtils;
...
public class PresenterImpl implements VerificationContract.Presenter {
    ...
    private final Mat matNv21 = new Mat(AppConfig.CAMERA_PREVIEW_HEIGHT + AppConfig.CAMERA_PREVIEW_HEIGHT / 2,
